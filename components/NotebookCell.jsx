    ...
    <>
      <div className={cellClasses} id={`endpoint-${endpoint._id}`}>
        ...
        <div className="nb-cell-header" onClick={() => setExpanded((v) => !v)}>
          {/* Status dot */}
          <span className={`status-dot ${loading ? 'fetching' : statusClass} nb-cell-status-dot`} />

          {/* Title */}
          <div className="nb-cell-title-wrap">
            {endpoint.isPinned && <span title="Pinned" style={{ fontSize: 13, marginRight: 4 }}>📌</span>}
            <span className="nb-cell-name-text">{endpoint.name}</span>
            {endpoint.hasUpdate && (
              <span className="badge badge-update" style={{ marginLeft: 6 }}>
                🔄 Updated
              </span>
            )}
          </div>
          ...
          {/* Chevron */}
          <div className="nb-cell-chevron-wrap">
            <svg
          ...
          {/* URL */}
          <div className="nb-cell-url-wrap">
            <div className="nb-cell-url" title={endpoint.url}>{endpoint.url}</div>
          </div>

          {/* Meta stats */}
          <div className="nb-cell-meta-wrap">
            <div className="nb-cell-meta">
              ...
              {endpoint.status === 'error' && (
                <span className="nb-cell-error-msg" style={{ fontSize: 12, color: 'var(--rose)' }}>
          ...
          {/* Tags */}
          <div className="nb-cell-tags-wrap" onClick={(e) => e.stopPropagation()}>
            {endpoint.tags?.length > 0 && (
              <div className="nb-cell-tags">
          ...
          {/* Actions */}
          <div className="nb-cell-actions-wrap" onClick={(e) => e.stopPropagation()}>
            <div className="nb-cell-actions">
              ...
              >
                ...
                <span className="refresh-btn-text">{loading ? 'Fetching…' : 'Refresh'}</span>
              </button>
              ...
              <div style={{ position: 'relative' }}>
                ...
                {menuOpen && (
                  <div
                    className="nb-cell-actions-menu"
